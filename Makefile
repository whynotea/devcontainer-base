...
github-release:
	release-please github-release --token=${GH_TOKEN} --repo-url=whynotea/devcontainer-base --target-branch=main

.PHONY: github-release-dry-run
github-release-dry-run:
	release-please --dry-run=true github-release --token=${GH_TOKEN} --repo-url=whynotea/devcontainer-base --target-branch=main
